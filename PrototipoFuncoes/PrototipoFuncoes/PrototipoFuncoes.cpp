...
// o nome é main e ela não recebe parâmetos neste exemplo 
// (podem existir argumentos de linha de comando que serão enviados a dois parâmetros da função main
